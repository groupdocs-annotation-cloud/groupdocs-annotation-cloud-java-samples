...
public class Annotation_Java_Add_TextField_Annotation {
	...
	public static void main(String[] args) {
		...
		try {
			...
			annotations[0].setFontSize(12);
			annotations[0].setOpacity(0.7);
			annotations[0].setType(TypeEnum.TEXTFIELD);
			annotations[0].setText("This is text field annotation");
			annotations[0].setFieldText("Text field text");
			...
			System.out.println("Expected response type is void: TextField Annotation added.");
