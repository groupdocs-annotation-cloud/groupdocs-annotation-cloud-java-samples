...
public class Annotation_Java_Add_TextReplacement_Annotation {
	...
	public static void main(String[] args) {
		...
		try {
			...
			annotations[0].setFieldText("Text to replace");
			...
			System.out.println("Expected response type is void: TextReplacement Annotation added.");
