...
public class Annotation_Java_Add_Text_Annotation {
	...
	public static void main(String[] args) {
		...
		try {
			...
			annotations[0].setType(TypeEnum.TEXT);
			annotations[0].setText("This is text annotation");
			...
			System.out.println("Expected response type is void: Text Annotation added.");
