...
public class Annotation_Java_Add_Watermark_Annotation {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Expected response type is void: Watermark Annotation added.");
